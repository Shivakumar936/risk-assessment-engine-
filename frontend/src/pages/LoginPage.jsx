        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
          ...
          <div className="space-y-1 text-xs text-gray-600">
            <div className="flex justify-between">
              ...
              <span className="font-mono">admin@gmail.com / admin124</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Manager:</span>
              <span className="font-mono">manager@gmail.com / manager124</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Viewer:</span>
              <span className="font-mono">viewer@gmail.com / viewer124</span>
            </div>
          </div>
        </div>
